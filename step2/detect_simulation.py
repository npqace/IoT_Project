from mock_controller import MockModbusMaster
from controller import ModbusMaster  # Import the actual ModbusMaster class
...
class LightGesture:
    ...
    def light_simulation(self, img, lights):
        # Simulate the light behavior on the image
        # This is a placeholder implementation
        for i, light in enumerate(lights):
            if light:
                cv2.putText(img, f"Light {
                            i+1} ON", (50, 50 + i*30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
            else:
                cv2.putText(img, f"Light {
                            i+1} OFF", (50, 50 + i*30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
        return img
...
if __name__ == "__main__":
    ...
    model_path = "./models/model_07-12 15_40_NeuralNetwork_best"
